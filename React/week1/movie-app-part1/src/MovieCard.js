                ...
                <div className="movie-card">
                    ...
                    <div className="right">
                        ...
                        <div className="footer">
                            ...
                            <button className={fav?"unfavourite-btn":"favourite-btn"} onClick={this.toggleFav}>{fav?"UnFavorite":"Favorite"}</button>:

                            <button className={isInCart?"remove-cart-btn":"cart-btn"} onClick={this.toggleCart}>{isInCart?"Remove From Cart":"Add to Cart"}</button>
